...
# Save results #
################
out_name = paste0(path, "data/sim4_weakcor.RDS")
...
# results #
###########
# Figure S10: Heat map of correlation matrix when chemicals are weakly correlated
seed = seedsave[5]
truth = generate_data(m, J, d=5, q, xi=xi, alpha=alpha, 
                        delta_mean=1, df=0.3, seed=seed)$truth
...
# ggsave("~/BMC/Figure/sim4_weakcorrelation.eps")
  
#----------------------------------------------------------------------------------------------------------------------------------
# Table S3: Summary of results from Simulation 4 under weakly correlated structure
