...
# hold out 10% of the cells 
set.seed(123)
missing_idx_ij <- sample.int(m*J, floor(0.1*m*J))
row = missing_idx_ij-m*(ceiling(missing_idx_ij/m)-1)
col = ceiling(missing_idx_ij/m)
missing_idx <- cbind(row, col)
...
# # Store results #
# #################
# rmse = tr_aucg = tt_aucg = xi <- rep(NA, 50)
...
#   sigsq_xi = 1
# 
#   hyper = list(a = a, R = R, mu_xi = mu_xi, sigsq_xi = sigsq_xi)
#   
#   ##################
#   # initial values #
#   ##################
...
#              hetero = FALSE, hetero_simpler = FALSE,
...
#               hetero = FALSE, hetero_simpler = FALSE,
#               gamma_simpler = "bmc0", mgsp_adapt = FALSE,
#               update_xi = FALSE, apply_cutoff = FALSE, verbose = FALSE)
#                   
...
#               hetero = FALSE, hetero_simpler = FALSE,
#               gamma_simpler = "bmcj", mgsp_adapt = FALSE,
#               update_xi = FALSE, apply_cutoff = FALSE, verbose = FALSE)
# 
...
# 
# # save result
# saveRDS(list(res = res, res0 = res0,
#              resi = resi, resj = resj,
